...
function editar(){
    ...
    $.ajax({    
        ...
        url: 'http://129.151.116.109:9090/api/Admin/update',
...
function eliminar(idElemento){
    ...
    $.ajax({    
        ...
        url : "http://129.151.116.109:9090/api/Admin/"+idElemento,
        type: 'DELETE',
        contentType:'application/json',
        success : function(json, textStatus, xhr) {
...
function cargar(idItem){
    $.ajax({    
        url : "http://129.151.116.109:9090/api/Admin/"+idItem,
        type : 'GET',
        dataType : 'JSON',        
...
function consultar(){
    $.ajax({
        url:"http://129.151.116.109:9090/api/Admin/all",
        type:"GET",
        datatype:"JSON",
...
function guardar(){
    ...
    $.ajax({
        ...
        url:"http://129.151.116.109:9090/api/Admin/save",
