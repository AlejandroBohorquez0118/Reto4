...
function editar(){
    ...
    $.ajax({    
        ...
        url: 'http://129.151.116.109:9090/api/Client/update',
...
function eliminar(idElemento){
    ...
    $.ajax({    
        ...
        url : "http://129.151.116.109:9090/api/Client/"+idElemento,
        type: 'DELETE',
        contentType:'application/json',
        success : function(json, textStatus, xhr) {
...
function cargar(idItem){
    $.ajax({    
        url : "http://129.151.116.109:9090/api/Client/"+idItem,
        type : 'GET',
        dataType : 'JSON',        
...
function guardar(){
    ...
    $.ajax({
        ...
        url:"http://129.151.116.109:9090/api/Client/save",
